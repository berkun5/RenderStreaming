...
/// </summary>
public class RemoteInputField : MonoBehaviour
{
    ...
    void Start()
    {
        manager.playerInput.onDeviceChange += Manager_onDeviceChange;
    }
        ...
        if (change == InputDeviceChange.Added)
        {
            switch (device)
            {
                case Keyboard keyboard:
                    ...
                    //manager.playerInput.onDeviceChange -= manager.OnDeviceChange;
