  ...
  constructor(ipPort) {
    ...
    if (location.protocol === "https:") {
      ...
      if (ipPor == null) {
        ...
        console.log("registered IPPORTTTTT");
      }
      else {
        websocketUrl = "ws://" + ipPor;
        console.log("registered IPPOR");
      }
    ...
    console.log("websocketUrl: " + websocketUrl); //SERVER IP ADRESS (URL)
    ...
    this.websocket.onmessage = (event) => {
      ...
      console.log("ONMESSAGE: " + JSON.stringify(msg)); //connection id messages
      if (!msg || !this) {
      ...
      switch (msg.type) {
        ...
        case "candidate":
          ...
          break;
        default:
          this.dispatchEvent(new CustomEvent('defo', { detail: msg }));
          break;
      }
    };
  }
